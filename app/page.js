...
const ACTION_CARDS = [
  ...
  },
  {
    ...
    color: "#44CC44", glow: "#88FF88",
    bg: "linear-gradient(135deg, #001A00 0%, #0A4A0A 50%, #001A00 100%)",
    border: "#33AA33", desc: "Strike before anyone can react", tagline: "Strike from the shadows.",
  },
];
